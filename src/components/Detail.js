...
function Detail() {
    ...
    function fetchData() {
        axios.get(apiUrl + '/api/activity/activity/DepartmentActiveActivities/' + localStorage.getItem("dashboarddepartmentId"),
            {
                headers: {
                ...
                $('#activeActivities').DataTable(getPropertiesForActivityDT([2, 3, 4]));
        ...
        axios.get(apiUrl + '/api/activity/activity/getDepartmentActivityCount/' + localStorage.getItem("dashboarddepartmentId"),
            {
                headers: {
                    'Token-Code': localStorage.getItem('token_code'),
                    'Content-Type': 'application/json',
        ...
        axios.get(apiUrl + '/api/activity/activity/DepartmentCompletedActivities/' + localStorage.getItem("dashboarddepartmentId"),
            {
                headers: {
                    'Token-Code': localStorage.getItem('token_code'),
                    'Content-Type': 'application/json',
        ...
        <div>
            <div id="page_content">
                <div id="page_content_inner">
                    ...
                    <h4 className="heading_a uk-margin-bottom">{localStorage.getItem("dashboarddepartmentName")} Department Activities</h4>
                            ...
                            <div className="md-card-content small-padding">
                                <ul className="uk-tab" data-uk-tab="{connect:'#tabs_anim1', animation:'scale'}">
                                    ...
                                    <div className="uk-vertical-align-middle uk-float-right">
                                        <ActivityExportExcel filename={localStorage.getItem("dashboarddepartmentName")} activeActivities={activeActivities} completedActivities={completedActivities} />
                                            ...
                                            <div className="md-card-content small-padding">
                                                <div className="uk-overflow-container">
                                                    <table id="activeActivities" className="uk-table uk-table-nowrap table_check">
                                                        <thead>
                                                            <tr>
                                                                <th className="uk-text-left" id="act_snum">S.No.</th>
                                                                ...
                                                                <th className="uk-text-left width">Alert Date</th>
                                                        ...
                                                        <tbody>
                                                            {activeActivities.map(activity => (
                                                                <tr className={classNames({ 'bgred': checkTodayExceed(activity.alert_date) })} key={activity.act_id}>
                                                                    ...
                                                                    { checkAdminUser() ?
                                                                        <td className="uk-text-left cell-vertical-middle cursor cell-wrap" data-uk-modal="{target:'#activity_actions'}" onClick={() => editingActivity({ activity })}>{activity.act_name}</td>
                                                                        :
                                                                        <td className="uk-text-left cell-vertical-middle cursor cell-wrap" data-uk-modal="{target:'#activity_actions'}" onClick={() => showingActivity({ activity })}>{activity.act_name}</td>
                                                                    }
                                                                    ...
                                                                    <td className="uk-text-left cell-vertical-middle">{dateFormat(activity.alert_date)}</td>
                                                                    <td className="uk-text-left cell-vertical-middle table-cell-height" style={{ height: '23px' }}>
                                                                                ...
                                                                                <div className="md-card-list">
                                                                                    <div className="md-card-list-item-menu" data-uk-dropdown="{mode:'click',pos:'bottom-right'}">
                                                                                        ...
                                                                                        <div className="uk-dropdown uk-dropdown-small">
                                                                                            <ul className="uk-nav">
                                                                                                {(activity.close_request == 1) && <li><a href="#" data-uk-modal="{target:'#activity_actions'}" onClick={() => declingActivity({ activity })}><i className="material-icons">&#xE149;</i> Decline</a></li>}
                                                                                                {(checkTodayExceed(activity.alert_date)) && <li><a href="#" data-uk-modal="{target:'#activity_actions'}" onClick={() => closingActivity({ activity })}><i className="material-icons">&#xE5CD;</i>Close</a></li>}
