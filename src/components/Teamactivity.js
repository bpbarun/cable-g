...
function Teamactivity() {
    ...
    function fetchData() {
        axios.get(apiUrl + '/api/activity/activity/TeamActiveActivities/' + localStorage.getItem('user_id'),
            {
                headers: {
        ...
        axios.get(apiUrl + '/api/activity/activity/getTeamAlertNotification/' + localStorage.getItem('user_id'),
            {
                headers: {
                    'Token-Code': localStorage.getItem('token_code'),
                    'Content-Type': 'application/json',
        ...
        axios.get(apiUrl + '/api/activity/activity/TeamCompletedActivities/' + localStorage.getItem('user_id'),
            {
                headers: {
                    'Token-Code': localStorage.getItem('token_code'),
                    'Content-Type': 'application/json',
        ...
        <div>
            <div id="page_content">
                <div id="page_content_inner">
                    ...
                    <h4 className="heading_a uk-margin-bottom">Team Activities</h4>
                            ...
                            <div className="md-card-content small-padding">
                                <ul className="uk-tab" data-uk-tab="{connect:'#tabs_anim1', animation:'scale'}">
                                    ...
                                    <div className="uk-vertical-align-middle uk-float-right">
                                        <ActivityExportExcel filename="Team Activities" activeActivities={activeActivities} completedActivities={completedActivities} />
                                        {checkAdminUser() &&
